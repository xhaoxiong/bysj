...
func (this *AuthServices) CreateUser(info *models.UserInfo) (models.User,error) {
...
func (this *AuthServices) UserinfoByOpenid(u *models.User) error {
	return this.repo.UserinfoByOpenid(u)
}
